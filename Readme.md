...
Si probleme de port -> redemarre les containers depuis github desktop 
...
6. Go to the global conaitner and click : "attach to a runiing container", select th php and go to var/www/symfony. Inside the `php` container, run `composer install` to install dependencies from `/var/www/symfony` folder.
